...
This is the PyTorch implementation for **LS-Meta** proposed in the paper **LS-Meta: Grounding Lightweight Meta-Embeddings in Network Structural Roles via LLM Supervision**.
